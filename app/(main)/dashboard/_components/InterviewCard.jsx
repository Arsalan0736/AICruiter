  ...
  return (
    <div className='p-5 bg-white rounded-lg border'>
        ...
        {!viewDetail ? <div className='grid grid-cols-2 gap-3 w-full mt-5'>
            <Button variant='outline' className={'w-full flex items-center justify-center gap-2'} onClick={copyLink}>
                <Copy/> Copy Link
            </Button>
            <Button className={'w-full flex items-center justify-center gap-2'} onClick={onSend}>
                <Send/> Send
            </Button>
        </div>
        : 
